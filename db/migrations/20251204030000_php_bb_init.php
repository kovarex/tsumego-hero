...
final class PhpBbInit extends AbstractMigration
{
    public function up(): void
    {
		// only for testing database where phpbb tables don't exist
		if ($this->hasTable('phpbb_acl_groups'))
			return;
