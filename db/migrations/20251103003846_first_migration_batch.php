...
/* First batch of migrations created and applied before phinx was integrated */
final class FirstMigrationBatch extends AbstractMigration
{
    public function up(): void
    {
		...
		$this->execute("
                      ...
                      UPDATE `set` SET included_in_time_mode = FALSE WHERE id in (42, 109, 114, 143, 172, 173, 181, 191, 207, 210, 228, 236, 237, 246, 251, 253, 29156, 33007, 74761);
