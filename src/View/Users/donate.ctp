	...
	<div id="login-box2" class="users form">
		<div class="left2 signin">
			...
			Thanks to the generous support of players like you, tsumego.com is the best place to solve Go problems. 
			Therefore, we thank you for considering supporting us as well! The following rewards await you: <br>
			<br>
