...
<tr>
	...
	<td width="33%" valign="top">
		<div align="right">	
		<font size="3px" style="font-weight:400;font-style:italic;">* Users can't win prizes two months in a row.</font>
		</div>
	</td>
</table>	
<table class="highscoreTable" border="0">
	...
	<?php
		...
		for($i=0; $i<count($users); $i++){
			...
			if($users[$i]['User']['name']!='SaberRider' && $users[$i]['User']['name']!='test11' && $users[$i]['User']['elo_rating_mode']!=1000){
