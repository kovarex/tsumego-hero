...
<form method="post" action="/tags/editAction/<?php echo $tag['id'] ?>">
	<table>
		<tr>
			...
			<td><input name="tag_name" value="<?php echo h($tag['name']) ?>" placeholder="Name" maxlength="50" type="text" id="tag_name" disabled="true"></td>
		</tr>
		<tr>
			<td><label for="tag_description">Description:</label></td>
			<td><textarea name="tag_description" rows="3" placeholder="Description" maxlength="3000" cols="30" id="tag_description"><?php echo h($tag['description']) ?></textarea></td>
		</tr>
		<tr>
			<td><label for="tag_link">Reference:</label></td>
			<td><input name="tag_link" value="<?php echo h($tag['link']) ?>" placeholder="Reference" maxlength="500" type="text" id="tag_link"></td>
		</tr>
	</table>
	<br>
