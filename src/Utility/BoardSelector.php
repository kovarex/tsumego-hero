...
class BoardSelector
{
	...
	static public function filterValidBits($boardsSelection)
	{
		$allowedBits = 0;
	...
	static public function getBoardInfo($index)
	{
		// linear search, but we search once per refresh, so w/e
		foreach (self::$boards as $board)
	...
	static public function selectBoard($boardsBitmask, $goldenTsumego, $setPreference)
	{
	...
	static public $DEFAULT_BOARDS_BITMASK = 0b11111111;
	static public $GOLDEN_TSUMEGO_INDEX = 46;
}
