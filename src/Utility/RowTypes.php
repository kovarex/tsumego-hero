 ...
 * @phpstan-type TsumegoRow array{id?: int, part?: string|null, part_increment?: int|null, description?: string|null, hint?: string|null, author?: string, solved?: int|null, failed?: int|null, rating?: float, minimum_rating?: float|null, maximum_rating?: float|null, userWin?: float, userLoss?: int, created?: string|null, minLib?: int|null, maxLib?: int|null, variance?: int|null, libertyCount?: int|null, insideLiberties?: int|null, eyeLiberties1?: int|null, eyeLiberties2?: int|null, semeaiType?: int|null, alternative_response?: int, pass?: int, activity_value?: int, deleted?: string|null, ...}
