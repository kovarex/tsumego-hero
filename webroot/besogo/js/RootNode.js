class RootNode extends Node
{
	...
	__construct(sizeX = 19, sizeY = 19)
		...
		root.nextIsBlack = function () {
			return this.nextMove() == BLACK;
		}
		...
		root.setStone = function (x, y, color) {
		...
		root.checkTsumegoHeroCompatibility = function (root) {
			...
			if (!this.hasChildIncludingVirtual()) {
				if (root.goal == GOAL_NONE &&
					...
					return {
						node: this,
						message: "Last solver move not marked correct (unless there are comments or markups)"
					};
