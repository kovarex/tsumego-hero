...
chmod 777 "$ROOT_DIR/forums/cache"
mkdir -p "$ROOT_DIR/forums/cache/production"
chmod 777 "$ROOT_DIR/forums/cache/production"
chmod 777 "$ROOT_DIR/forums/store"
chmod 777 "$ROOT_DIR/forums/files"
chmod 777 "$ROOT_DIR/forums/images/avatars/upload"
